...
function buildAppMenu(ctx) {
  ...
  const template = [
    ...
    { label: 'Bookmarks', accelerator: 'CmdOrCtrl+Shift+O', click: () => actions.openInternal('veil://bookmarks/') },
    { label: 'Passwords', accelerator: 'CmdOrCtrl+Shift+P', click: () => actions.passwords() },
        ...
        { label: 'Import from another browser…', click: () => actions.openInternal('veil://import/') },
    { label: 'Import from another browser…', click: () => actions.openInternal('veil://import/') },
        { type: 'separator' },
