...
// Veil: `browser` is an alias for the chrome global, set in vapi.js, so it
// is missing the same APIs. Same substitution, same reason.
import { chrome as browser } from './veil-chrome.js';
