...
// Veil: Electron implements a subset of the extension APIs, and replacing
// the chrome global from a script does not survive - see veil-chrome.js.
// Importing it here shadows the global for this file, which is the only
// one in uBlock that touches an API Electron does not have.
import { chrome } from './veil-chrome.js';
